...
팀프로젝트(Shelfeed · MoniMonitor · MSA Kafka · Cassandra)를 진행하며 마주친 개념을 그때그때 정리한 노트입니다. Notion에서 마크다운으로 미러링해 보관합니다.

## 목차

| 노트 | 프로젝트 | 작성일 |
|---|---|---|
| [이미지 lazy loading과 code splitting](이미지-lazy-loading과-code-splitting.md) | Shelfeed | 2026-08-17 |
| [파티셔닝과 샤딩](파티셔닝과-샤딩.md) | MoniMonitor | 2026-09-02 |
| [CQRS와 Query Facade + S3](CQRS와-Query-Facade-S3.md) | MoniMonitor | 2026-09-02 |
...
| [\[보안\] 웹 취약점과 암호화 (대칭/비대칭 키)](보안-웹취약점과-암호화-대칭-비대칭키.md) | 기타 | 2026-09-16 |
